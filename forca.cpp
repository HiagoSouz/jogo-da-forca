...
int main() {
    ...
    for (i=0;i<tamanho_palavra;i++)
        secreta[i]='_';                 //preenche uma string com o _ para mostrar ao usuário de acordo com o tamanho da palavra secreta
    ...
    while ((chances>0)&&(letras_acertadas<tamanho_palavra)){
        ...
        do {
         ...
         for(i=0;i<numero_tentativas;i++){   //loop para evitar que o usuário repita letras
            ...
            if(tentadas[i]==tentativa[0]){
                ...
                numero_tentativas--;
                 ...
                 ||verifica_tentativa==true); //verifica se a tentativa é válida, caso não, repete o loop até isso acontecer
